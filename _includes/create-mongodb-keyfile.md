...
To know more about the keyfile creation and permisions based on the Operating system read about [create keyfile](https://docker-x.github.io//Create-keyfile-for-MongoDB)