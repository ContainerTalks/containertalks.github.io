---
layout: post
title: "Hiding the server response"
description: "Hiding the server response"
categories: [ Caddy ]
image: assets/img/screenshots/insomnia-showing-server.png
featured: false
hidden: true
---
...
![Showing the Server response header](assets/img/screenshots/insomnia-showing-server.png), Used [insomnia](https://insomnia.rest/), HTTP client website like postman, to check with the header of the request.
